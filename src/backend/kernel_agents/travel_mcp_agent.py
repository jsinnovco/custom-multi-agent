...
class MCPTravelAgent(BaseAgent):
    """TripAdvisor Travel MCP agent implementation using Semantic Kernel and MCP.

       This is an TripAdvisor Travel MCP agent."""
    ...
    def __init__(
        ...
        agent_name: str = AgentType.MCP_TRAVEL.value,
        client=None,
        definition=None,
    ) -> None:
        """Initialize the TripAdvisor Travel MCP Agent.
        ...
        agent_name = AgentType.MCP_TRAVEL.value
    ...
    async def create(
        ...
        **kwargs: Dict[str, str],
        ...
        try:
            logging.info("Initializing TravelPlannerAgent from async init azure AI Agent")
